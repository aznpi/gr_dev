...
<wcm:widget path="widgets/bootstrap-site/resources/widget_resources_page_nav"/>
<div class="main-content row">      
    <div class="col-md-3 left-container">
        <ul class="nav nav-tabs tabs-left" role="tablist">
            ...
            <li role="presentation"><a href="#services" aria-controls="services" role="tab" data-toggle="tab">Service Overviews</a></li>
            <li role="presentation"><a href="#case-study" aria-controls="case-study" role="tab" data-toggle="tab">Case Studies</a></li>
            <li role="presentation"><a href="#white-papers" aria-controls="white-papers" role="tab" data-toggle="tab">White Papers</a></li>
        </ul>
        <div class="star">
                    ...
                    <ul class="list">
                        <li id="broker-dealer">
                            <div class="document-container">
                                ...
                                <div class="image-container"><i class="far fa-file-pdf fa-4x"></i></div>
                        ...
                        <li id="sec">
                            <div class="document-container">
                                ...
                                <div class="download-container">
                                    <div class="btn-download" rel="http://info.globalrelay.com/download-sec-compliance-guidebook" target="new"><i class="fa fa-file-pdf-o"></i></div>
                                </div>
                            </div>
                        </li>
                        <li id="iiroc">
                            <div class="document-container">
                                ...
                                <div class="description-container">
                                    ...
                                    <p>IIROC and MFDA Requirements and Global Relay Solutions for Electronic Communications Recordkeeping
    &amp; Supervision</p>
                                </div>
                                <div class="download-container">
                        ...
                        <li id="hipaa">
                            <div class="document-container">
                                ...
                                <div class="download-container">
                                    <div class="btn-download" rel="http://info.globalrelay.com/download-hipaa-compliance-guidebook"><i class="fa fa-file-pdf-o" target="new"></i></div>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li id="hp-case">
                            <div class="document-container">
                                ...
                                <div class="description-container">
                                    ...
                                    <p>HP case study on Global Relay's private data center.</p>
                                </div>
                                <div class="download-container">
                                    <div class="btn-download" rel="/resources/files/GlobaRelay_HP_caseStudy.pdf" target="new"><i class="fa fa-file-pdf-o"></i></div>
                                </div>
                            </div>
                        </li>
                        <li id="cat-case">
                            <div class="document-container">
                                ...
                                <div class="image-container"><i class="far fa-file-pdf fa-4x"></i></div>
                                <div class="description-container">
                                    <h3>Global Relay Power Profile</h3>
                                    <p>Caterpillar case study on Global Relay's private data center.</p>
                                </div>
                                <div class="download-container">
                                    <div class="btn-download" rel="http://info.globalrelay.com/hubfs/PDFs/Power_Profile_Global_Relay_Data_Center.pdf" target="new"><i class="fa fa-file-pdf-o"></i></div>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="document-container">
                                ...
                                <div class="description-container">
                                    ...
                                    <p>Country Club Financial selects on Global Relay for email &amp; social media compliance archiving.</p>
                                </div>
                                <div class="download-container">
            ...
            <div class="tab-pane fade" id="white-papers">
                <h3>White Papers</h3>
                <hr>
                <div class="resource-container">
                    <ul class="list">
                        ...
                        <li id="wp-2">
                            <div class="document-container">
                                ...
                                <div class="image-container"><i class="far fa-file-pdf fa-4x"></i></div>
                                <div class="description-container">
                                    <h3>Reconsider Instant Messaging in Finance</h3>
                                    <p>White Paper on the Barriers to IM’s Adoption in Finance &amp; How Global Relay Message Addresses Them</p>
                                </div>
                                <div class="download-container">
                                    <div class="btn-download" rel="https://info.globalrelay.com/download-im-white-paper" target="new"><i class="fa fa-file-pdf-o"></i></div>
                                </div>
                            </div>
                        </li>
                        <li id="wp-3">
                            <div class="document-container">
                                ...
                                <div class="image-container"><i class="far fa-file-pdf fa-4x"></i></div>
                                <div class="description-container">
                                    <h3>The Future of Compliant Text Messaging</h3>
                                    <p>White Paper on How Text for Global Relay Message Addresses the Risks that Financial Text Messaging Poses</p>
                                </div>
                                <div class="download-container">
                                    <div class="btn-download" rel="https://info.globalrelay.com/download-compliant-text-messaging-white-paper" target="new"><i class="fa fa-file-pdf-o"></i></div>
                                </div>
                            </div>
                        </li>
