...
$(document).ready(function(){
    ...
    $('#box-2,#box-3,#box-4').click(function(){
    	...
    	window.location = "/gr_dev/products/"+prodCat;
    });
    ...
    $(function () {
    	...
    	$('#btn-demo,#services-icon-container #message-icon,#services-icon-container #archive-icon,#services-icon-container #search-icon').popover({
