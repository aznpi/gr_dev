					...
					<div id="red-angle-landing" class="message-landing">
					    <section class="home-panel">
					        <div class="row red-angle">
					            ...
					            <div id="red-angle-carousel" class="carousel slide ms-teams-carousel slide-fade" data-ride="carousel" data-interval="5000">
					                <div class="col-md-6 left-container">
					
					                    <div id="title-top">
					
					                        <div id="title">
					                            <h1>Archiving for Microsoft Teams</h1>
					                        </div>
					                    </div>
					                    <div id="title-middle">
					                        <h4 class="body-text">Get control of your Microsoft Teams data. As an integrated Microsoft Teams partner, Global Relay provides your firm with a comprehensive Information Governance solution, enabling you to gain valuable insights into your business while reducing risk.</h4>
					                    </div>
					                    <div id="title-bottom">
					    ...
					    <section id="txt-panel" class="home-panel">
					        <div class="row">
					            <div class="col-md-12 manage-slack-panel">
					                <h2>MANAGE SLACK</h2>
					                <h3>By centralizing all your Microsoft Teams communications in Global Relay's secure, private cloud repository, you can:</h3>
					            </div>
					        </div>
					        <div class="row">
					            <div class="col-md-4">
					            ...
					            <div class="col-md-4">
					                <div id="panel-retention">
					                    ...
					                    <dl>
					                         ...
					                         <dd>Custom Microsoft Teams data retention and disposition terms</dd>
					                    </dl>
					                </div>
					            </div>
					        </div>
					        <div class="row">
					            <div class="col-md-4">
					                <div id="panel-analytics">
					                    ...
					                    <dl>
					                         <dt>Analytics</dt>
					                         <dd>Identify message trends and anomalies across all Microsoft Teams messages</dd>
					                    </dl>
					                </div>
					            </div>
					            <div class="col-md-4">
					                <div id="panel-legal-hold">
					                    ...
					                    <dl>
					                         <dt>Legal Hold</dt>
					                         <dd>Enforce automated Legal Hold on relevant Microsoft Teams communications</dd>
					                    </dl>
					                </div>
					            </div>
					            <div class="col-md-4">
					                <div id="panel-ediscovery">
					                    ...
					                    <dl>
					                         <dt>eDiscovery</dt>
					                         <dd>Produce defensible Microsoft Teams data easily for investigations and litigation</dd>
					                    </dl>
					                </div>
					            </div>
					        </div>
					    ...
					    <section id="video" class="home-panel">
					        <div class="row">
					            <div class="col-md-12 info-content">
					                <p class="bold" style="margin-top:15px;">Global Relay captures over 50 different data types, including Microsoft Teams messaging.</p>
