<div id="main-header-banner" class="row navbar-fixed-top header-2">
	<div class="top-info-banner">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<ul>
						<li class="tel">1 866 484 6630</li>
						<li class="demo"><a href="forms/demo/request">Demo</a></li>
						<li class="login" id="btn-login-container">
							<a href="#">Login</a>
							<div id="menu">
								<div id="arrow"></div>
	...
	<div class="container main-header-inner-container">
		<nav class="navbar navbar-default">
		    <div class="navbar-header">
				...
				<div class="navbar-brand"><a href="/"><img src="${baseUrl}/template-resources/images/internal/logos/logo_main_gr.png" width="240px"/></a></div>
			</div>
			...
			<div id="mega-menu" <c:choose><c:when test="${page !='home'}">class="collapse navbar-collapse js-navbar-collapse active"</c:when><c:otherwise>class="collapse navbar-collapse js-navbar-collapse"</c:otherwise></c:choose>>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown mega-dropdown search-form-container">
						
						<a href="#" data-toggle="dropdown"><i class="fas fa-search"></i></a>
						<div class="arrow-up"></div>
						<ul id="search-menu" class="dropdown-menu mega-dropdown-menu row">
							<li class="col-sm-12">
								<form id="form1" action="${baseUrl}/search">
									...
									<button form="form1" type="submit" class="btn btn-clear"><i class="fas fa-search"></i></button>				
								</form>
							</li>
						</ul>
					</li>
