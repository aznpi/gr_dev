					...
					<div class="main-content row service-container">
						...
						<div class="col-md-8 left-container">
							<div id="product-title" class="row">
								<h1>Solutions for Swaps, Futures & Commodities </h1>
							</div>
							
							<div class="description row-container">
								<h4>Overview</h4>
								<p>The recordkeeping and supervision requirements of the Commodity Futures Trading Commission (CFTC) are more complex and wide-reaching than ever before. All swap dealers, major swap participants, retail foreign exchange dealers, futures commission merchants, commodity trading advisors, commodity pool operators and introducing brokers required to register with the CFTC must comply with these requirements, which include obligations to retain written and oral communications and supervise employees.</p>
							</div>
							<div>
								<h4>Global Relay Solution</h4>
								<p>Global Relay Archive helps CFTC-registered firms navigate and comply with the complex regulatory requirements for the recordkeeping and supervision of electronic communications.</p>	
							</div>
								  ...
								  <div class="tab-content">
								  	...
								  	<div role="tabpanel" class="tab-pane in fade active" id="recordkeeping">
									  		...
									  		<ul>
									  			...
									  			<li><span class="bold">Appoint Global Relay as your Technical Consultant</span> for independent CFTC mandated access</li>
									  			<li><span class="bold">Leverage our in-house Legal team</span> to complete the required CFTC <a href="${baseUrl}/resources/faq#cftc">filings</a></li>
									  	...
									  	<div role="tabpanel" class="tab-pane in fade" id="supervision">
									  		...
									  		<div class="description">
									  			<h4>Supervision</h4>
									  			<p>With Global Relay Archive’s flexible, turnkey supervision and monitoring tools, your firm can efficiently enforce its communications policies for compliance, proper usage, and corporate governance. Supervision features include:</p>
									  		</div>
									  		<ul>
									  			...
									  			<li><span class="bold">Create wizard commands</span> to perform multiple actions with a single click 
									  	...
									  	<div role="tabpanel" class="tab-pane in fade" id="audits">
									  		...
									  		<ul>
									  			...
									  			<li><span class="bold">Use case management tools</span> to identify, organize and review data
						...
						<div class="col-md-4 right-container">
							...
							<div class="main-product-image">
								<div class="main-product-image">
						            <a href="http://info.globalrelay.com/hubfs/PDFs/global_relay_cftc_161121.pdf" target="_blank"><img src="${baseUrl}/template-resources/images/internal/background/bg_cftc_guidebook.png" class="img-responsivness" /></a>
						        </div>
								<div class="learn-txt">
									<h5>Learn more about your recordkeeping and supervision obligations under CFTC rules at our Swaps, Futures &amp; Commodities Resource Page <a href="${baseUrl}/resources/faq#investment-advisors">Learn more<i class="red-arrow"></i></a></h5>
								</div>
							</div>
					...
					<div id="related-container" class="row">
						...
						<div class="col-md-4">
							<div class="related-box">
								<div>
									<div class="title">
										<h5>Download the Free CFTC Compliance Guidebook</h5>
									</div>
									<div class="description">
										<p>Our Compliance Guidebook provides an overview of your recordkeeping and supervision obligations under CFTC Rules and how Global Relay Archive meets each compliance requirement.</p>
									</div>
									<div class="more-info">
