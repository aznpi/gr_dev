							...
							<div class="col-md-12">
								...
								<hr>
								    <div class="form-group">
								        <input type="text" class="form-control input-lg" name="partnerCompanyName" id="partnerCompanyName" placeholder="Company">
								        <div class="msgContainer">
								            <p id="partnerCompanyNameFldMsg"></p>
								        </div>
								    </div>
								    <div class="form-group">
								...
								<div class="form-group">
								 ...
								 <div class="display-none">				 	
								    ...
								    <div class="form-group">
								        ...
								        <div class="msgContainer">
								        	<p id="customerItContact.nameFldMsg"></p>
								        </div>
								    </div>
								    <div class="form-group">
							...
							<div class="col-md-12">
								...
								<div id="additional-number-users">
									...
									<div class="form-group">
									        ...
									        <div class="msgContainer">
									        	<p id="numUsersOfBloombergFldMsg"></p>
									        </div>
									</div>
									<div class="form-group">
