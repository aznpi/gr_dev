					...
					<div class="main-content row service-container">
						...
						<div class="col-md-8 left-container">
							<div id="product-title" class="row">
								<h1>Solutions for Insurance</h1>
							</div>
							<div class="description row-container">
								<h4>Overview</h4>
								<p>Insurance companies face numerous federal and state regulatory obligations surrounding the preservation, safeguarding and accessibility of business records. Depending on the nature of your business, you may be subject to the Gramm–Leach–Bliley Act (GLBA), the <a href="${baseUrl}/services/hipaa">Health Insurance Portability and Accountability Act</a> (HIPAA), <a href="${baseUrl}/services/hipaa">the Health Information Technology Act</a> (HITECH), or other legislation and regulations. These requirements pose significant challenges, but can be efficiently addressed with the right policies and technology.</p>
							</div>
							<div>
								<h4>Global Relay Solution</h4>
								<p>Global Relay Archive helps insurance companies securely store and retrieve electronic communications for recordkeeping, eDiscovery, audits, and risk management.</p>	
							</div>
							<div role="tabpanel" id="bd-tabpanel">
								  ...
								  <ul class="nav nav-tabs" role="tablist">
								    ...
								    <li role="presentation"><a href="#audits" aria-controls="supervision" role="tab" data-toggle="tab">eDISCOVERY &amp; AUDITS</a></li>
								    <li role="presentation"><a href="#risk-management" aria-controls="audits" role="tab" data-toggle="tab">RISK MANAGEMENT</a></li>
								  </ul>
								  ...
								  <div class="tab-content">
								  	...
								  	<div role="tabpanel" class="tab-pane in fade active" id="recordkeeping">
									  		...
									  		<ul>
									  			...
									  			<li><span class="bold">Retain data</span> in accordance with regulatory obligations and internal policies</li>
									  	...
									  	<div role="tabpanel" class="tab-pane in fade" id="audits">
									  		...
									  		<div class="description">
									  			...
									  			<p>Insurance companies face significant business and legal risks related litigation and other liability. They may also be subject to regulatory audits that can result in large fines for any identified violations. Electronic communications can supply valuable evidence in these cases to prove “who said what, when.”</p>
									  		</div>
									  		<ul>
						...
						<div class="col-md-4 right-container">
							<div class="main-product-image">
								<img src="${baseUrl}/template-resources/images/internal/background/bg_insurance_product_page.png" class="img-responsive"/>
							</div>
					...
					<div id="related-container" class="row">
						...
						<div class="col-md-4">
							<div class="related-box">
								<div>
									<div class="title">
										<h5>Download the Free ‘Archive for Insurance’ Datasheet</h5>
									</div>
									<div class="description">
										<p>Our Archive for Insurance datasheet provides an overview of how Global Relay Archive can benefit your organization.</p>
									</div>
									<div class="more-info">
