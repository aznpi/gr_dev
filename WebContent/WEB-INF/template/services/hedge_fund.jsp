					...
					<div class="main-content row service-container">
						...
						<div class="col-md-8 left-container">
							<div id="product-title" class="row">
								<h1>Solutions for Hedge Funds</h1>
							</div>
							<div class="description row-container">
								<h4>Overview</h4>
								<p>By eliminating the ‘private advisor’ exemption from the Investment Advisors Act of 1940, the Dodd-Frank Act transformed the regulatory environment for Hedge Funds. Many Hedge Funds must now register with the SEC or their state and comply with recordkeeping and supervision regulations. SEC rules require registered advisors to retain written communications relating to their investment advisory business and implement supervisory policies and controls to prevent and detect regulatory violations.</p>
							</div>
							<div>
								<h4>Global Relay Solution</h4>
								<p>Global Relay Archive provides a total recordkeeping, supervision, and audit solution for Hedge Funds subject to SEC and state requirements. We provide services to 70% of SEC-registered Hedge Funds and work closely with many of the prime brokers, including Goldman Sachs, Credit Suisse, Morgan Stanley, and UBS.</p>	
							</div>
