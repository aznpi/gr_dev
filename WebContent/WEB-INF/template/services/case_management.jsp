...
<c:set var="product" value="case-management"/>
					...
					<div class="main-content row">
						...
						<div class="col-md-4 right-container">
							...
							<div class="main-product-image">
								<img src="${baseUrl}/template-resources/images/internal/background/photos/img_casemanagement_headshot.jpg" class="img-responsive"/>
							</div>
