					...
					<div class="main-content row service-container">
						...
						<div class="col-md-8 left-container">
							<div id="product-title" class="row">
								<h1>Solutions for Registered Investment Advisors</h1>
							</div>
							<div class="description row-container">
								<h4>Overview</h4>
								<p>The SEC requires Registered Investment Advisors (RIAs) to implement a compliance archiving and monitoring solution to archive and supervise all electronic communications. These requirements extend to all written business-related communications, including email, instant messaging, Bloomberg&reg;, Thomson Reuters, mobile messaging, and social media. Small and mid-sized investment advisors must register with their state and comply with similar recordkeeping and supervision rules.</p>
							</div>
							<div>
								<h4>Global Relay Solution</h4>
								<p>Global Relay Archive provides a total recordkeeping, supervision, and audit solution for RIAs subject to SEC and state requirements:</p>	
							</div>
							<div role="tabpanel" id="bd-tabpanel">
								  ...
								  <div class="tab-content">
								  	...
								  	<div role="tabpanel" class="tab-pane in fade active" id="recordkeeping">
									  		...
									  		<ul>
									  			<li><span class="bold">Automatically capture communications data</span>, including email, instant messaging, Bloomberg®, Thomson Reuters, mobile messaging, social media, and <a href="${baseUrl}/services/archive?page=real-time-data#data-feeds">more</a></li>
