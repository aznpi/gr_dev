				...
				<div id="main-content-container" class="row non-home-container">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="sub-header">for Finra Firms</h3>
						</div>
					</div>
					<form onsubmit="quoteRequestBeforeSubmit();quoteRequestLoading();jQuery.ajax({type:'post',data:jQuery(this).serialize(), url:'/forms/quote/requestAjax?quoteType=FINRA',success:function(data,textStatus){quoteRequestSuccess(data);},error:function(XMLHttpRequest,textStatus,errorThrown){quoteRequestFailure();},complete:function(XMLHttpRequest,textStatus){quoteRequestComplete()}});return false" method="post" action="/forms/quote/requestAjax?quoteType=FINRA" class="gr-form contact-us-form" id="quoteRequestForm">
						<div class="main-content row">
							<div class="col-md-12">
								<h3>Contact Information</h3>
								<hr>
									<div class="form-group finra-number">
								        <input type="text" class="form-control input-lg" name="crd.number" id="crd.number" placeholder="Finra CRD Number (If Applicable)">
								        <i class="fa fa-question-circle" data-toggle="popover" data-content="(IF APPLICABLE) Your firm's FINRA CRD number. You will need to be an Active/Pending FINRA Firm to proceed. If you're not sure what this is, check with FINRA's online <a href='http://www.finra.org/Investors/ToolsCalculators/BrokerCheck/' target='_blank'>BrokerCheck tool</a>"></i>
								    </div>
							...
							<div class="col-md-12">
								...
								<div class="form-group">
								 ...
								 <div class="btn-container">
									 <button type="submit" class="btn btn-success left clear-both" name="quoteRequestSubmit" id="quoteRequestSubmit">Submit</button>
									 <button type="submit" class="btn btn-success right clear-both" name="cancelButton" id="cancelButton">Submit</button>
								</div>						 
							</div>
						</div>
					</form>
